...
/****** Object:  StoredProcedure [dbo].[AAII_PF_WEEKLY_V1]    Script Date: 10/22/2015 15:31:04 ******/
SET ANSI_NULLS ON
GO
...
-- SCRIPT: PREMIUM FLEX WEEKLY SALES DATA
-- =================================================




--ALTER PROCEDURE [dbo].[AAII_PF_WEEKLY_V1]
--AS
	...
	--SET @MYDateUTC = '2015-06-01'
	SET @startDateUTC = ods.ConvertDate( @timeZone, CAST(CONVERT(VARCHAR,@MYDateUTC-7, 101) AS DateTime) , 1, 0 )
	SET @endDateUTC   = ods.ConvertDate( @timeZone,CAST(CONVERT(VARCHAR, DATEADD(day, 1, @MYDateUTC-1), 101) AS DateTime) , 1, 0 )
	
	--SET @startDateUTC = '2014-10-01'
	--SET @endDateUTC = '2014-11-01'
...
BEGIN TRY DROP TABLE TEMP_PF_WEEKLY_V1 END TRY BEGIN CATCH END CATCH

SELECT CONVERT (DATE, BOOKINGDATE, 110) BOOKINGDATE, DATEPART(YYYY,BOOKINGDATE) BOOKINGYEAR, DATENAME(MM,BOOKINGDATE) BOOKINGMONTH, DATENAME(WK,BOOKINGDATE) BOOKINGWEEK, CARRIERCODE,
...
--SELECT COUNT (*) FROM TEMP_PF_WEEKLY_V1
